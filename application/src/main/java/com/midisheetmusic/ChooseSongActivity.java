...
class ScanMidiFiles extends AsyncTask<Integer, Integer, ArrayList<FileUri>> {
    ...
    protected void onPreExecute() {
        ...
        try {
            ...
            Log.e("ChooseActivity", e.toString());
        }
    }
...
public class ChooseSongActivity extends ListActivity implements TextWatcher {
    ...
    public void onCreate(Bundle state) {
        ...
        ArrayList list = (ArrayList) getLastNonConfigurationInstance();
        try {
            for (Object o : list) {
                songlist.add((FileUri) o);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.scan_files) {
            scanForSongs();
            return true;
        } else if (i == R.id.browse_files) {
            browseForSongs();
            return true;
        } else {
